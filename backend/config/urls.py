...
urlpatterns = [
    ...
    # Person 1 (Omar) — authentication & identity, vendors / POs / vehicles / documents.
    path('api/v1/', include('accounts.urls')),
    path('api/v1/', include('inventory.urls')),
    # Person 2 (Aya) — sales/deal lifecycle, payments & financing, reporting.
    # Person 1's /users, /roles, /vendors, /purchase-orders, /vehicles,
    # /documents, /customers land under the same prefix.
